...
sudo yum update -y
sudo yum install gcc make wget nano tar gzip -y
sudo yum group reinstall "Development Tools" -y
sudo yum upgrade -y
...
install_3proxy() {
    ...
    echo "net.ipv4.tcp_rmem = 8192 87380 4194304" >> /etc/sysctl.conf
    echo "net.ipv4.tcp_wmem = 8192 87380 4194304" >> /etc/sysctl.conf
